...
DEFAULT_INPUT = REPO_ROOT / "SNA" / "Datos" / "naucalpan_datos_tabulares_consolidados.csv"
...
def cargar_corpus(path: Path) -> pd.DataFrame:
    """Lee el historico tabular consolidado de Naucalpan."""
    if not path.exists():
...
def main() -> None:
    ...
    print("=" * 70)
    print("[SNA Fase 2 - LDA] historico de Naucalpan")
