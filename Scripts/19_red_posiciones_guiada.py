...
def build_network_data(
    ...
    # Cada posicion conserva sus propios nodos de palabras. Una misma palabra
    # puede cumplir funciones distintas en dos posiciones del mismo tema y no
    # debe fusionarlas visualmente ni crear atajos entre ambos grupos.
