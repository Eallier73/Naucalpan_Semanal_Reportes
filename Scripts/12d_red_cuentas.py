"""
Fase 5: Red completa de palabras + cuentas (fusion).
...
Salida:
  - clusters/red_completa/red_naucalpan_cuentas.html
...
<head>
<meta charset="utf-8">
<title>Red historica de Naucalpan - palabras y cuentas</title>
{vis_css}
{vis_js}
<style>
...
<div id="topBar">
  <div class="grp" style="background: #1a2a1a;">
    <a class="bak" href="red_naucalpan_historico.html">volver a red de palabras</a>
  </div>
...
def main():
    ...
    out_html = base / "clusters" / "red_completa" / "red_naucalpan_cuentas.html"
    ...
    metrics = {
        "corpus": "historico consolidado de Naucalpan",
