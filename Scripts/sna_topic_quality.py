...
EDITORIAL_RULES = (
    ...
    EditorialRule(
        frozenset({"gobernadora", "futbol", "delfina", "gomez", "equipo", "financiero"}), 3,
        "Gobierno estatal, fútbol y referencias económicas",
        "Mezcla menciones a una figura de gobierno con fútbol y asuntos financieros. La coincidencia no sostiene una interpretación temática única.",
