...
Entradas esperadas:
  SNA/Datos/naucalpan_datos_tabulares_consolidados.csv
...
def main() -> None:
    ...
    html_out = build_html(nodes, edges, meta, topic_info, base, "Naucalpan historico")
    (out_dir / "red_naucalpan_posiciones.html").write_text(html_out, encoding="utf-8")
    ...
    print("[5/5] OK")
    for path in [
        out_dir / "red_naucalpan_posiciones.html",
