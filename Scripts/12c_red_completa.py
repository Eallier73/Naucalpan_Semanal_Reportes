#!/usr/bin/env python3
"""
SNA Fase 2.7: Red completa multi-capa + metricas de brokerage/endogamia.
...
# Las lecturas anteriores pertenecen a CDMX. En Naucalpan los nombres y
...
def render_pyvis(
    ...
    # sobre miles de nodos al abrir el HTML y reducen mucho el tiempo de carga.
    ...
    css_fix = (
        ...
        "  #topBar select { width:100%; margin:3px 0 6px; padding:4px; background:#181818; color:#fff; border:1px solid #555; border-radius:3px; }\n"
        ...
        "  .topic-order-score { color:#888; font-size:10px; margin-left:4px; }\n"
    ...
    panel_html = (
        ...
        "    bindTooltip();\n"
        "    initTables();\n"
        "    // Todos los filtros nacen activos: evitamos actualizar miles de\n"
        "    // nodos y aristas durante la carga inicial.\n"
